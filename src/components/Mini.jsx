...
<NavLink key={index} to={postData.post.id}>
  <div className="flex items-start p-3 pt-4 px-6 pl-5 shadow-md mini-post">
    {/* Foto Profil */}
    <img
      ...
      <div className="flex items-center justify-between text-gray-300 mt-4">
        <div className="flex items-center space-x-4">
          ...
          <button
            onClick={(e) => {
              e.stopPropagation();
              e.preventDefault(); // Tambahkan ini juga
            }}
            className="flex items-center hover:text-blue-500"
          >
            <GoComment className="comment-icon" />
            <span className="ml-1 comment-content">
